...
public class ModuleCommand extends Command {
    ...
    public void execute(String[] commands) {
        if (commands.length == 1) {
            sendMessage("Modules: ");
            Iterator var9 = Legacy.moduleManager.getCategories().iterator();
            ...
            while (var9.hasNext()) {
                ...
                Module module1;
                for (Iterator var6 = Legacy.moduleManager.getModulesByCategory(category).iterator(); var6.hasNext(); modules = modules + (module1.isEnabled() ? ChatFormatting.GREEN : ChatFormatting.RED) + module1.getName() + ChatFormatting.WHITE + ", ") {
