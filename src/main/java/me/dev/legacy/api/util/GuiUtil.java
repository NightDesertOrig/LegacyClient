...
public class GuiUtil {
    public static void drawString(String paramString, float paramFloat1, float paramFloat2, int paramInt) {
        if (Legacy.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            Legacy.fontRenderer.drawStringWithShadow(paramString, (double) paramFloat1, (double) paramFloat2, paramInt);
        } else {
    ...
    public static void drawString(String paramString, int paramInt1, int paramInt2, int paramInt3) {
        if (Legacy.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            Legacy.fontRenderer.drawStringWithShadow(paramString, (double) paramInt1, (double) paramInt2, paramInt3);
        } else {
    ...
    public static void drawCenteredString(String paramString, int paramInt1, int paramInt2, int paramInt3) {
        if (Legacy.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            Legacy.fontRenderer.drawStringWithShadow(paramString, (double) (paramInt1 - Legacy.fontRenderer.getStringWidth(paramString) / 2), (double) paramInt2, paramInt3);
        } else {
            Minecraft.func_71410_x().field_71466_p.func_175063_a(paramString, (float) (paramInt1 - Legacy.fontRenderer.getStringWidth(paramString) / 2), (float) paramInt2, paramInt3);
        }
