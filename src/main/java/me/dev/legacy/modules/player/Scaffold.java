...
public class Scaffold extends Module {
    ...
    public Setting rotation = this.register(new Setting("Rotate", false));
    ...
    public void place(BlockPos posI, EnumFacing face) {
        ...
        if (newSlot != -1) {
            ...
            if (!mc.field_71439_g.func_70093_af() && BlockUtil.blackList.contains(mc.field_71441_e.func_180495_p(pos).func_177230_c())) {
